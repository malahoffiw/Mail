...
export const isMessageOrDraftCreated = (messageStatus: TRPCStatus, draftStatus: TRPCStatus) => {
    return messageStatus === "success" || draftStatus === "success"
}

export const isMessageOrDraftInProcess = (messageStatus: TRPCStatus, draftStatus: TRPCStatus) => {
